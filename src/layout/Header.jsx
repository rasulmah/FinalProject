  ...
  return (
    <header className="header">
      ...
      <div className="searchContainer">
        ...
        <button><svg className='iconSearch'  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"><path fill="currentColor" fill-rule="evenodd" d="M8 14A6 6 0 1 0 8 2a6 6 0 0 0 0 12Zm0 1A7 7 0 1 0 8 1a7 7 0 0 0 0 14Z" clip-rule="evenodd"></path><path fill="currentColor" fill-rule="evenodd" d="m12.854 12.146 4.5 4.5-.707.708-4.5-4.5.707-.707Z" clip-rule="evenodd"></path></svg></button>
        </form>
      </div>

      <div className="banner-icons d-flex">
        <a href="" className="banner-icon d-flex justify-content-center align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"><path class="ico-Wishlist_Middle" fill="transparent" fill-rule="evenodd" d="M.5 6.143a4.643 4.643 0 0 1 8.214-2.965 4.643 4.643 0 0 1 8.214 2.965c0 1.282-.566 2.398-1.36 3.283-.822.918-2.536 2.687-4.044 4.226a609.753 609.753 0 0 1-2.455 2.49.5.5 0 0 1-.71 0 717.66 717.66 0 0 1-2.455-2.49c-1.508-1.54-3.221-3.308-4.044-4.226C1.066 8.54.5 7.425.5 6.143Z" clip-rule="evenodd"></path><path class="ico-Wishlist_Outer" fill="currentColor" fill-rule="evenodd" d="M5.143 2A4.143 4.143 0 0 0 1 6.143c0 1.127.497 2.129 1.232 2.949.814.908 2.52 2.668 4.03 4.21a611.137 611.137 0 0 0 2.452 2.488 637.037 637.037 0 0 0 2.453-2.488c1.51-1.542 3.215-3.302 4.03-4.21.735-.82 1.232-1.822 1.232-2.95a4.143 4.143 0 0 0-7.33-2.645.5.5 0 0 1-.77 0A4.13 4.13 0 0 0 5.144 2Zm3.571 14.5-.354.352-.228-.229a566.813 566.813 0 0 1-2.585-2.622c-1.505-1.536-3.227-3.313-4.06-4.241C.637 8.81 0 7.58 0 6.143a5.143 5.143 0 0 1 8.714-3.7 5.143 5.143 0 0 1 8.714 3.7c0 1.437-.635 2.666-1.487 3.617-.832.928-2.554 2.705-4.06 4.241a602.406 602.406 0 0 1-2.585 2.623l-.227.228-.355-.352Zm0 0 .355.352a.5.5 0 0 1-.71 0l.355-.352Z" clip-rule="evenodd"></path></svg>
        </a>
        <a href="" className="banner-icon d-flex justify-content-center align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"><path fill="currentColor" fill-rule="evenodd" d="M13.186 6.5H4.76a2 2 0 0 0-1.993 1.834l-.68 8.166h13.82l-.729-8.177A2 2 0 0 0 13.186 6.5Zm2.989 1.734A3 3 0 0 0 13.186 5.5H4.76a3 3 0 0 0-2.99 2.75L1 17.5h16l-.825-9.266Z" clip-rule="evenodd"></path><path fill="currentColor" fill-rule="evenodd" d="M9 2.5A2.5 2.5 0 0 0 6.5 5v3.5h-1V5a3.5 3.5 0 1 1 7 0v3.5h-1V5A2.5 2.5 0 0 0 9 2.5Z" clip-rule="evenodd"></path></svg>
        </a>
        <a href="" className="banner-icon d-flex justify-content-center align-items-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"><path fill="currentColor" fill-rule="evenodd" d="M9.48 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM3.434 12.008A3.5 3.5 0 0 1 6.79 9.5h5.427a3.5 3.5 0 0 1 3.365 2.539l1.378 4.824-.961.274-1.379-4.824a2.5 2.5 0 0 0-2.403-1.813H6.79a2.5 2.5 0 0 0-2.397 1.791l-1.434 4.85L2 16.859l1.434-4.85Z" clip-rule="evenodd"></path></svg>
          </a>
      </div>
      </div>
